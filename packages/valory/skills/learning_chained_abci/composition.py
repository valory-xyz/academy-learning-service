...
abci_app_transition_mapping: AbciAppTransitionMapping = {
    ...
    LearningAbci.FinishedMechRequestPreparationRound: TxSettlementAbci.RandomnessTransactionSubmissionRound,
    LearningAbci.FinishedRound: ResetAndPauseAbci.ResetAndPauseRound,
    TxSettlementAbci.FinishedTransactionSubmissionRound: LearningAbci.PostTransactionRound,
