...
abci_app_transition_mapping: AbciAppTransitionMapping = {
    ...
    LearningAbci.FinishedMechTxPreparationRound: TxSettlementAbci.RandomnessTransactionSubmissionRound,
    LearningAbci.FinishedRound: ResetAndPauseAbci.ResetAndPauseRound,
    TxSettlementAbci.FinishedTransactionSubmissionRound: LearningAbci.PostTransactionPayload,
